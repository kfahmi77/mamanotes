...
void main() {
  final jsonData = {
    "tahunPertamaAnakId": "D3ACWKSnbo4NFg7BH2vcL",
  ...
  group('Data Tahun Pertama Anak  :', () {
    ...
    test('update data tahun pertama anak', () async {
      final instance = FakeFirebaseFirestore();
      ...
      jsonData['foto_tahun_pertama_anak'] = 'url baru';
