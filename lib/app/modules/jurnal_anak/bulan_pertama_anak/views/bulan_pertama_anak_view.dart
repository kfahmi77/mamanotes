...
import 'edit_bulan_pertama_anak_view.dart';

class BulanPertamaAnak extends GetView<BulanPertamaAnakController> {
  const BulanPertamaAnak({super.key});
...
class BulanPertamaAnakView extends StatelessWidget {
  final BulanPertamaAnakModel bulanPertamaAnak;

  const BulanPertamaAnakView({super.key, required this.bulanPertamaAnak});
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              onPressed: () {
                Get.to(() => EditBulanPertamaAnakView(
                      bulanPertamaAnak: bulanPertamaAnak,
                    ));
              },
              icon: Icon(
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.to(() => DetailFotoView(
                            urlImage: bulanPertamaAnak.imageUrl,
                          ));
                    },
                    child: Container(
                      width: 300.w,
