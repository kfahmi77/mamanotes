...
import '../controllers/edit_gigi_pertama_anak.dart';
import '../models/gigi_pertama_anak_model.dart';

class EditGigiPertamaAnakView extends GetView<EditGigiPertamaAnakController> {
  final GigiPertamaAnakModel gigiPertamaAnak;

  const EditGigiPertamaAnakView({Key? key, required this.gigiPertamaAnak})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EditGigiPertamaAnakController());
