...
class Kolase1View extends GetView<Kolase1Controller> {
                        ...
                        Expanded(
                          child: Row(
                            children: <Widget>[
                              Expanded(
                                child: Obx(
                                  () => controller.imagePaths[4] == ''
                                      ? InkWell(
                                          onTap: () =>
                                              controller.getImageFromGallery(4),
                                          child: SizedBox(
                                            width: 230.w,
                                            height: 120.h,
                                            child: Container(
                              ...
                              Expanded(
                                child: Obx(
                                  () => controller.imagePaths[5] == ''
                                      ? InkWell(
                                          onTap: () =>
                                              controller.getImageFromGallery(5),
                                          child: SizedBox(
                                            width: 230.w,
                                            height: 120.h,
                                            child: Container(
